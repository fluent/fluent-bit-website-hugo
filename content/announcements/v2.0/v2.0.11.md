...
BSD and OSX. We are proud to announce the availability of **Fluent Bit v2.0.11**.
...
[Fluent Bit](https://fluentbit.io) v2.0 is the stable release!, new changes on this version:
 ...
 - Libs
   - CTraces: upgrade to v0.3.0
   - CMetrics: upgrade to v0.6.0

 - Packaging
   - AL2023 backport support (#7110)
