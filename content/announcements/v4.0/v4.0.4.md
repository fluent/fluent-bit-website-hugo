...
- **[Kmsg (Input)](https://docs.fluentbit.io/manual/pipeline/inputs/kmsg)**
...
- **[Content_modifier (Processor)](https://docs.fluentbit.io/manual/pipeline/processors/content_modifier)**
  - fix leak when converting to JSON ([PR #10450](https://github.com/fluent/fluent-bit/pull/10450))
  - fix data type in comparisson ([PR #10450](https://github.com/fluent/fluent-bit/pull/10450))
